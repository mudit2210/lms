...
const NAV_ITEMS = [
  ...
  {
    id: 'newcourses', label: 'New Courses', icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 'eventscheduled', label: 'Event Schedule', icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 'group', label: 'Group Join', icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 'attendance', label: 'Attendances', icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export default function TraineeSidebar({
  ...
  return (
    <aside className={`trainee-sidebar ${isSidebarOpen ? 'open' : ''}`}>
      {/* Header */}
      <div className="trainee-sidebar-header">
        <div className="trainee-sidebar-logo">

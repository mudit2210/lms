            ...
            >
              <div className="space-y-1 max-w-[70%]">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-extrabold text-slate-800 text-xs sm:text-sm truncate max-w-[150px]">{topic.title}</h4>
                </div>
                <div className="flex gap-2 items-center text-[9px] font-bold text-slate-400 uppercase pl-6 mt-0.5">
                  <span>{topic.id}</span>
                  <span>•</span>
                  <span>Seq: {idx + 1}</span>
                </div>

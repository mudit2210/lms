    ...
    <div className="w-full min-h-screen bg-slate-100 flex font-sans text-slate-800 antialiased select-none">
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-68 flex flex-col transform transition-all duration-300 ${
        ...
        <div className={`p-6 flex justify-between items-center ${
          ...
          <div>
            <h2 className={`text-xl font-extrabold tracking-tight flex items-center gap-2 ${theme === 'light' ? 'text-slate-800' : 'text-white'}`}>
              <span className={`inline-block w-3.5 h-3.5 rounded-xs animate-pulse ${theme === 'light' ? 'bg-emerald-500' : 'bg-yellow-400'}`}></span>
              LMS Console
            </h2>
            <p className={`text-[10px] font-bold uppercase tracking-wider mt-0.5 ${theme === 'light' ? 'text-emerald-600' : 'text-emerald-400'}`}>Reports & Analytics</p>
          </div>
          <button
        ...
        <nav className="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto">
          ...
          >
            <svg className={`w-4.5 h-4.5 shrink-0 ${theme === 'light' ? 'text-slate-900' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
            <span className={`${theme === 'light' ? 'text-slate-950' : 'text-slate-300'}`}>Command Dashboard</span>
          </button>
          ...
          {/* Group: Portal Access */}
          <div className={`border-t my-3 pt-3 ${theme === 'light' ? 'border-slate-200/80' : 'border-white/10'}`}>
          ...
          >
            ...
            <span className={`${theme === 'light' ? 'text-slate-955' : 'text-slate-300'}`}>e-Hostel Logistics</span>
          </button>
          ...
          >
            ...
            <span className={`${theme === 'light' ? 'text-slate-955' : 'text-slate-300'}`}>Knowledge (KMS)</span>
          </button>
          ...
          >
            <svg className={`w-4.5 h-4.5 shrink-0 ${theme === 'light' ? 'text-slate-900' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
            <span className={`${theme === 'light' ? 'text-slate-955' : 'text-slate-300'}`}>User Accounts</span>
          </button>

          <div className={`border-t my-4 pt-4 space-y-1.5 ${theme === 'light' ? 'border-slate-200/80' : 'border-white/5'}`}>
            ...
            >
              <svg className={`w-4.5 h-4.5 shrink-0 ${theme === 'light' ? 'text-slate-900' : 'text-blue-450'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            >
              ...
              <span className={`${theme === 'light' ? 'text-slate-955' : 'text-slate-300'}`}>Back to Public Site</span>
            </button>
          </div>
        </nav>

        <div className={`p-4 border-t text-xs font-semibold ${
          theme === 'light' ? 'border-slate-200 bg-slate-100/50 text-slate-500' : 'border-white/5 bg-[#03211b] text-slate-455'
        }`}>
